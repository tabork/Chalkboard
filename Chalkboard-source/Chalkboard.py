...
class main:
    ...
    def gui(self, width, height):
        ...
        if self.brushClicked == False:
            self.screen.blit(pygame.image.load("brush.png").convert_alpha(), (3,30))
        else:
            self.screen.blit(pygame.image.load("brush_clicked.png").convert_alpha(), (3,30))
            self.screen.blit(pygame.image.load("color_txt.png").convert_alpha(), (33,4))
            if self.whiteSelected:
                self.screen.blit(pygame.image.load("white_box.png").convert_alpha(), (80, 4))
            elif self.blackSelected:
                self.screen.blit(pygame.image.load("black_box.png").convert_alpha(), (80,4))
            elif self.redSelected:
                self.screen.blit(pygame.image.load("red_box.png").convert_alpha(), (80,4))
            elif self.orangeSelected:
                self.screen.blit(pygame.image.load("orange_box.png").convert_alpha(), (80,4))
            elif self.limeSelected:
                self.screen.blit(pygame.image.load("lime_box.png").convert_alpha(), (80,4))
            elif self.greenSelected:
                self.screen.blit(pygame.image.load("green_box.png").convert_alpha(), (80,4))
            elif self.blueSelected:
                self.screen.blit(pygame.image.load("blue_box.png").convert_alpha(), (80,4))
            elif self.tealSelected:
                self.screen.blit(pygame.image.load("teal_box.png").convert_alpha(), (80,4))
            elif self.purpleSelected:
                self.screen.blit(pygame.image.load("purple_box.png").convert_alpha(), (80,4))
            elif self.yellowSelected:
                self.screen.blit(pygame.image.load("yellow_box.png").convert_alpha(), (80,4))
            self.screen.blit(pygame.image.load("arrow.png").convert_alpha(), (213,4))
            self.screen.blit(pygame.image.load("size_txt.png").convert_alpha(), (240, 5))
            self.screen.blit(pygame.image.load("slider.png").convert_alpha(), (290,8))
            self.screen.blit(pygame.image.load("slider_handle.png").convert_alpha(), (self.slider_x, 14))
            if self.squareBrushClicked:
                self.screen.blit(pygame.image.load("square_clicked.png").convert_alpha(), (350, 3))
            else:
                self.screen.blit(pygame.image.load("square.png").convert_alpha(), (350,3))
            if self.circleBrushClicked:
                self.screen.blit(pygame.image.load("circle_clicked.png").convert_alpha(), (380, 3))
            else:
                self.screen.blit(pygame.image.load("circle.png").convert_alpha(), (380, 3))
        if self.eraserClicked == False:
            self.screen.blit(pygame.image.load("eraser.png").convert_alpha(), (3, 60))
        else:
            self.screen.blit(pygame.image.load("eraser_clicked.png").convert_alpha(), (3, 60))
            self.screen.blit(pygame.image.load("size_txt.png").convert_alpha(), (33, 5))
            self.screen.blit(pygame.image.load("slider.png").convert_alpha(), (83,8))
            self.screen.blit(pygame.image.load("slider_handle.png").convert_alpha(), (self.slider_eraser_x, 14))
            if self.squareClicked:
                self.screen.blit(pygame.image.load("square_clicked.png").convert_alpha(), (138, 3))
            else:
                self.screen.blit(pygame.image.load("square.png").convert_alpha(), (138,3))
            if self.circleClicked:
                self.screen.blit(pygame.image.load("circle_clicked.png").convert_alpha(), (168, 3))
            else:
                self.screen.blit(pygame.image.load("circle.png").convert_alpha(), (168, 3))
        if self.rectClicked == False:
            self.screen.blit(pygame.image.load("rectangle.png").convert_alpha(), (3,90))
        else:
            self.screen.blit(pygame.image.load("rectangle_clicked.png").convert_alpha(), (3,90))
            self.screen.blit(pygame.image.load("color_txt.png").convert_alpha(), (33,4))
            if self.whiteSelected:
                self.screen.blit(pygame.image.load("white_box.png").convert_alpha(), (80, 4))
            elif self.blackSelected:
        ...
        if self.ellipseClicked == False:
            self.screen.blit(pygame.image.load("ellipse.png").convert_alpha(), (3,120))
        else:
            self.screen.blit(pygame.image.load("ellipse_clicked.png").convert_alpha(), (3,120))
            self.screen.blit(pygame.image.load("color_txt.png").convert_alpha(), (33,4))
            if self.whiteSelected:
                self.screen.blit(pygame.image.load("white_box.png").convert_alpha(), (80, 4))
            elif self.blackSelected:
        ...
        if self.lineClicked == False:
            self.screen.blit(pygame.image.load("line.png").convert_alpha(), (3, 150))
        else:
            self.screen.blit(pygame.image.load("line_clicked.png").convert_alpha(), (3,150))
            self.screen.blit(pygame.image.load("color_txt.png").convert_alpha(), (33,4))
            if self.whiteSelected:
                self.screen.blit(pygame.image.load("white_box.png").convert_alpha(), (80, 4))
            elif self.blackSelected:
            ...
            self.screen.blit(pygame.image.load("size_txt.png").convert_alpha(), (240, 5))
            self.screen.blit(pygame.image.load("slider.png").convert_alpha(), (290,8))
            self.screen.blit(pygame.image.load("slider_handle.png").convert_alpha(), (self.slider_line_x, 14))
        self.screen.blit(pygame.image.load("fill_txt.png").convert_alpha(), (450, 3))
        if self.blackFillSelected:
            self.screen.blit(pygame.image.load("black_box.png").convert_alpha(), (540,4))
        elif self.whiteFillSelected:
            self.screen.blit(pygame.image.load("white_box.png").convert_alpha(), (540,4))
        elif self.redFillSelected:
            self.screen.blit(pygame.image.load("red_box.png").convert_alpha(), (540,4))
        elif self.limeFillSelected:
            self.screen.blit(pygame.image.load("lime_box.png").convert_alpha(), (540,4))
        elif self.greenFillSelected:
            self.screen.blit(pygame.image.load("green_box.png").convert_alpha(), (540,4))
        elif self.orangeFillSelected:
            self.screen.blit(pygame.image.load("orange_box.png").convert_alpha(), (540,4))
        elif self.blueFillSelected:
            self.screen.blit(pygame.image.load("blue_box.png").convert_alpha(), (540,4))
        elif self.yellowFillSelected:
            self.screen.blit(pygame.image.load("yellow_box.png").convert_alpha(), (540,4))
        elif self.tealFillSelected:
            self.screen.blit(pygame.image.load("teal_box.png").convert_alpha(), (540,4))
        elif self.purpleFillSelected:
            self.screen.blit(pygame.image.load("purple_box.png").convert_alpha(), (540,4))
        self.screen.blit(pygame.image.load("arrow.png").convert_alpha(), (673, 4))
        self.screen.blit(pygame.image.load("clear.png").convert_alpha(), (self.cx,4))
        if self.arrowClicked:
            self.screen.blit(pygame.image.load("white_box.png").convert_alpha(), (80,24))
            self.screen.blit(pygame.image.load("black_box.png").convert_alpha(), (80,44))
            self.screen.blit(pygame.image.load("red_box.png").convert_alpha(), (80,64))
            self.screen.blit(pygame.image.load("orange_box.png").convert_alpha(), (80,84))
            self.screen.blit(pygame.image.load("lime_box.png").convert_alpha(), (80,104))
            self.screen.blit(pygame.image.load("green_box.png").convert_alpha(), (80,124))
            self.screen.blit(pygame.image.load("blue_box.png").convert_alpha(), (80,144))
            self.screen.blit(pygame.image.load("teal_box.png").convert_alpha(), (80,164))
            self.screen.blit(pygame.image.load("purple_box.png").convert_alpha(), (80,184))
            self.screen.blit(pygame.image.load("yellow_box.png").convert_alpha(), (80, 204))
        if self.fillArrowClicked:
            self.screen.blit(pygame.image.load("white_box.png").convert_alpha(), (540,24))
            self.screen.blit(pygame.image.load("black_box.png").convert_alpha(), (540,44))
            self.screen.blit(pygame.image.load("red_box.png").convert_alpha(), (540,64))
            self.screen.blit(pygame.image.load("orange_box.png").convert_alpha(), (540,84))
            self.screen.blit(pygame.image.load("lime_box.png").convert_alpha(), (540,104))
            self.screen.blit(pygame.image.load("green_box.png").convert_alpha(), (540,124))
            self.screen.blit(pygame.image.load("blue_box.png").convert_alpha(), (540,144))
            self.screen.blit(pygame.image.load("teal_box.png").convert_alpha(), (540,164))
            self.screen.blit(pygame.image.load("purple_box.png").convert_alpha(), (540,184))
            self.screen.blit(pygame.image.load("yellow_box.png").convert_alpha(), (540, 204))
        pygame.display.flip()
    def setup(self):
        pygame.init()
    ...
    def fillScreen(self, yco):
        if yco in range(24, 44):
            ...
            self.yellowFillSelected = False
            self.fillArrowClicked = False
            self.screen.blit(pygame.image.load("menu_screen.png"), (0,0))
            ...
            for event in pygame.event.get():
                if event.type == QUIT:
                    ...
                    if self.rectClicked and xco not in range(0,30) and yco not in range(0,30):
                        ...
                        pygame.image.save(self.screen, "menu_screen.png")
                    ...
                    self.scr = pygame.image.load("screen.png").convert_alpha()
                    if self.rectClicked:
                    ...
                    pygame.image.save(self.screen,"fs_screen.png")
                    ...
                    self.gui(self.width, self.height)
                    self.screen.fill(self.fill)
                    self.screen.blit(pygame.image.load("fs_screen.png").convert_alpha(),(0,0))
    def rect_drag(self):
        if self.placed == True:
